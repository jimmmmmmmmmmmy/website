...
_recipes_pil_prescript(['BmpImagePlugin', 'WmfImagePlugin', 'PixarImagePlugin', 'MpoImagePlugin', 'MpegImagePlugin', 'BlpImagePlugin', 'IcnsImagePlugin', 'FitsImagePlugin', 'XpmImagePlugin', 'XVThumbImagePlugin', 'WebPImagePlugin', 'IptcImagePlugin', 'QoiImagePlugin', 'ImImagePlugin', 'PsdImagePlugin', 'TiffImagePlugin', 'PngImagePlugin', 'SunImagePlugin', 'EpsImagePlugin', 'JpegImagePlugin', 'FliImagePlugin', 'MspImagePlugin', 'GbrImagePlugin', 'TgaImagePlugin', 'PpmImagePlugin', 'GribStubImagePlugin', 'DdsImagePlugin', 'DcxImagePlugin', 'Hdf5StubImagePlugin', 'GifImagePlugin', 'XbmImagePlugin', 'IcoImagePlugin', 'PcxImagePlugin', 'SgiImagePlugin', 'PdfImagePlugin', 'FpxImagePlugin', 'CurImagePlugin', 'PalmImagePlugin', 'McIdasImagePlugin', 'FtexImagePlugin', 'ImtImagePlugin', 'BufrStubImagePlugin', 'Jpeg2KImagePlugin', 'PcdImagePlugin', 'SpiderImagePlugin', 'MicImagePlugin'])
